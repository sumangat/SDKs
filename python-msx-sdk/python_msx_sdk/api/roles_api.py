...
class RolesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_role_by_name = _Endpoint(
            settings={
                'response_type': (Role,),
                'auth': [],
                'endpoint_path': '/idm/api/v8/roles/name/{name}',
            ...
            callable=__get_role_by_name
        )

        def __get_roles_list(
            self,
            ids,
            **kwargs
        ):
            ...
            >>> thread = api.get_roles_list(ids, async_req=True)
            >>> result = thread.get()
        ...
        self.get_roles_list = _Endpoint(
            settings={
                'response_type': ([Role],),
                'auth': [],
                'endpoint_path': '/idm/api/v8/roles/list',
                'operation_id': 'get_roles_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
