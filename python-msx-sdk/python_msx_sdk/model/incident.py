...
class Incident(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, external_id, description, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            category (str): inquiry|software|hardware|network|database. [optional] if omitted the server will use the default value of "inquiry"  # noqa: E501
            impact (str): [optional] if omitted the server will use the default value of "Low"  # noqa: E501
            priority (str): [optional] if omitted the server will use the default value of "Planning"  # noqa: E501
            severity (str): [optional] if omitted the server will use the default value of "Low"  # noqa: E501
            state (str): [optional] if omitted the server will use the default value of "New"  # noqa: E501
            subcategory (str): [optional]  # noqa: E501
            tenant (str, none_type): [optional]  # noqa: E501
            urgency (str): [optional] if omitted the server will use the default value of "Low"  # noqa: E501
        """
