...
class WorkflowCategoryUpdate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, title, description, schema_id, *args, **kwargs):  # noqa: E501
        """WorkflowCategoryUpdate - a model defined in OpenAPI
