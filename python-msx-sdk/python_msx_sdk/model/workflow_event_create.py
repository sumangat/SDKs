...
class WorkflowEventCreate(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, target_id, schema_id, properties, *args, **kwargs):  # noqa: E501
        """WorkflowEventCreate - a model defined in OpenAPI
