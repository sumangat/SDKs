...
class VulnerabilitiesPage(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'contents': ([Vulnerability],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, page, page_size, has_next, has_previous, contents, *args, **kwargs):  # noqa: E501
        """VulnerabilitiesPage - a model defined in OpenAPI

        Args:
            page (int):
            page_size (int):
            has_next (bool, none_type):
            has_previous (bool, none_type):
