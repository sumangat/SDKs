...
class TemplateApplication(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, target_id, target_type, *args, **kwargs):  # noqa: E501
        """TemplateApplication - a model defined in OpenAPI
