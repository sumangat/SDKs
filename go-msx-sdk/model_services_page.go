...
type _ServicesPage ServicesPage
...
func (o *ServicesPage) UnmarshalJSON(bytes []byte) (err error) {
	varServicesPage := _ServicesPage{}

	if err = json.Unmarshal(bytes, &varServicesPage); err == nil {
		*o = ServicesPage(varServicesPage)
	}
...
func NewNullableServicesPage(val *ServicesPage) *NullableServicesPage {
	return &NullableServicesPage{value: val, isSet: true}
}
