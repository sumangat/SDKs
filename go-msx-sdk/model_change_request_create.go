...
type _ChangeRequestCreate ChangeRequestCreate
...
func (o *ChangeRequestCreate) UnmarshalJSON(bytes []byte) (err error) {
	varChangeRequestCreate := _ChangeRequestCreate{}

	if err = json.Unmarshal(bytes, &varChangeRequestCreate); err == nil {
		*o = ChangeRequestCreate(varChangeRequestCreate)
	}
...
func NewNullableChangeRequestCreate(val *ChangeRequestCreate) *NullableChangeRequestCreate {
	return &NullableChangeRequestCreate{value: val, isSet: true}
}
