...
func (o *SitesPage) UnmarshalJSON(bytes []byte) (err error) {
	varSitesPage := _SitesPage{}

	if err = json.Unmarshal(bytes, &varSitesPage); err == nil {
		*o = SitesPage(varSitesPage)
	}
...
func NewNullableSitesPage(val *SitesPage) *NullableSitesPage {
	return &NullableSitesPage{value: val, isSet: true}
}
