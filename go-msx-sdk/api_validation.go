...
func (r ApiGetValidateProductVersionPageRequest) Execute() (VulnerabilityValidationPage, *_nethttp.Response, error) {
	return r.ApiService.GetValidateProductVersionPageExecute(r)
}

/*
 * GetValidateProductVersionPage Returns a filtered page of validations.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiGetValidateProductVersionPageRequest
 */
...
func (a *ValidationApiService) GetValidateProductVersionPageExecute(r ApiGetValidateProductVersionPageRequest) (VulnerabilityValidationPage, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  VulnerabilityValidationPage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ValidationApiService.GetValidateProductVersionPage")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/vulnerability/api/v8/vulnerabilities/validations"
...
func (r ApiValidateProductVersionRequest) Execute() (VulnerabilityValidation, *_nethttp.Response, error) {
	return r.ApiService.ValidateProductVersionExecute(r)
}

/*
 * ValidateProductVersion Validate registered product / verison combinations for vulnerabilities.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiValidateProductVersionRequest
 */
...
func (a *ValidationApiService) ValidateProductVersionExecute(r ApiValidateProductVersionRequest) (VulnerabilityValidation, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  VulnerabilityValidation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ValidationApiService.ValidateProductVersion")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
