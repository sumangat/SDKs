...
type _BillingPricesPage BillingPricesPage
...
func (o *BillingPricesPage) UnmarshalJSON(bytes []byte) (err error) {
	varBillingPricesPage := _BillingPricesPage{}

	if err = json.Unmarshal(bytes, &varBillingPricesPage); err == nil {
		*o = BillingPricesPage(varBillingPricesPage)
	}
...
func NewNullableBillingPricesPage(val *BillingPricesPage) *NullableBillingPricesPage {
	return &NullableBillingPricesPage{value: val, isSet: true}
}
