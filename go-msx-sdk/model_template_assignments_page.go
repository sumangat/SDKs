...
type _TemplateAssignmentsPage TemplateAssignmentsPage
...
func (o *TemplateAssignmentsPage) UnmarshalJSON(bytes []byte) (err error) {
	varTemplateAssignmentsPage := _TemplateAssignmentsPage{}

	if err = json.Unmarshal(bytes, &varTemplateAssignmentsPage); err == nil {
		*o = TemplateAssignmentsPage(varTemplateAssignmentsPage)
	}
...
func NewNullableTemplateAssignmentsPage(val *TemplateAssignmentsPage) *NullableTemplateAssignmentsPage {
	return &NullableTemplateAssignmentsPage{value: val, isSet: true}
}
