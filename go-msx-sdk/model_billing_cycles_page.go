...
type _BillingCyclesPage BillingCyclesPage
...
func (o *BillingCyclesPage) UnmarshalJSON(bytes []byte) (err error) {
	varBillingCyclesPage := _BillingCyclesPage{}

	if err = json.Unmarshal(bytes, &varBillingCyclesPage); err == nil {
		*o = BillingCyclesPage(varBillingCyclesPage)
	}
...
func NewNullableBillingCyclesPage(val *BillingCyclesPage) *NullableBillingCyclesPage {
	return &NullableBillingCyclesPage{value: val, isSet: true}
}
